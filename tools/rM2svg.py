...
# if landscape
# default_y_width = 1404
# default_x_width = 1872
    ...
    for layer in range(nlayers):
        ...
        for stroke in range(nstrokes):
            ...
            if pen == 0 or pen == 1:
                ...
                width = 16 * width - 27
                opacity = 0.9
            elif pen == 12: # Paintbrush
                width = 30 * width - 27
                opacity = 1.0
            elif pen == 13: # Mechanical Pencil
                width = 16 * width - 27
                opacity = 0.9
            elif pen == 14: # Pencil
                width = 16 * width - 27
                opacity = 0.9
            elif pen == 15: # Ballpoint
                width = 16 * width - 27
                opacity = 0.9
            elif pen == 16: # Marker
                width = 16 * width - 27
                opacity = 0.9
            elif pen == 17: # Pencil-Sharp
                width = 16 * width - 27
            elif pen == 18: # Highlighter
                width = 45 * width - 27
                opacity = 0.4
                if coloured_annotations:
                  colour = 3
            ...
            for segment in range(nsegments):
                ...
                # if landscape
                # ratio = (y_width/x_width)/(1404/1872)
                #print ("ratio!",ratio)
                if ratio > 1:
                   xpos = ratio*((xpos*x_width)/1404)
                   ypos = (ypos*y_width)/1872
                #  if landscape
                #    xpos = ratio*((xpos*x_width)/1872)
                #    ypos = (ypos*y_width)/1404
                else:
                    xpos = (xpos*x_width)/1404
                    ypos = (1/ratio)*(ypos*y_width)/1872
                #  if landscape
                #    xpos = (xpos*x_width)/1872
                #    ypos = (1/ratio)*(ypos*y_width)/1404
                if pen == 0:
                    if 0 == segment % 8:
